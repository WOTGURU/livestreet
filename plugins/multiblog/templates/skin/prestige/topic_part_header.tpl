                ...
                <div class="wraps-topic">
                    <div class="box">
                        ...
                        <ul class="topic-info">
                            ...
                            {foreach from=$aBlogs item=oBlog name=multiblogs}
                                {if !$smarty.foreach.multiblogs.first}, {/if}<a href="{$oBlog->getUrlFull()}" class="topic-blog">{$oBlog->getTitle()|escape:'html'}</a>
                            {/foreach}
                            </li>
                            <li class="dash">-</li>
