...
class PluginAutoopenid_HookLogin extends Hook {    
    ...
    public function RegisterHook() {
        ...
        //$this->AddHook('template_form_login_end', 'LoginTpl', __CLASS__);
...
//		$this->AddHook('template_menu_settings', 'MenuSettingsTpl', __CLASS__);
    ...
    public function Logout() {
    	setcookie('vk_app_'.Config::Get('plugin.autoopenid.vk.id'),'',1,Config::Get('sys.cookie.path'),Config::Get('sys.cookie.host'));
    }
    /**
    ...
    public function LoginTpl() {    	
    	...
    	return $this->Viewer_Fetch(Plugin::GetTemplatePath('autoopenid').'inject_login.tpl');
    }
    /**
    ...
    public function MenuSettingsTpl() {    	
		...
		return $this->Viewer_Fetch(Plugin::GetTemplatePath('autoopenid').'menu.setting.item.tpl');
    }
}
?>